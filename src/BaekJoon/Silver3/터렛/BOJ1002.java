...
/*
저는 해당 문제를 보고 원의 방정식을 생각해서 풀어 봤습니다.
(x1,y1)가 중심이고 반지름 r1인 원과, (x2,y2)가 중심이고 반지름이 r2인 원으로 생각하고 풀었습니다!
문제를 보면 두 범위가 겹치는 부분을 구해야하니까, 두원이 겹치는 부분의 개수를 구하면 되겠다 생각했어요!
따라서 두 중심 사이의 거리를 d로 놓는다고 가정했을떄,
동심원,
원이 원안에 있을떄,
외접일때,
내접일때,
